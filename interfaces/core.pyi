...
def input_text( label: str, value: str, buffer_length: int, flags: Any = 0) -> Tuple[bool, str]: ...
...
def menu_item(label: str, shortcut: str=None, selected: bool=False, enabled: bool=True) -> Tuple[bool, bool]: ...
